...
const translations = {
  ...
  tulu: {
    title: "ಭದ್ರತೆಡ್ದೆ ಕುಡೊರಿನ ವೆಬ್‌ಸೈಟ್ ಅಟ್ಪಾಯಿನಿ",
    blockedLabel: "ಅಟ್ಪಾಯಿನ URL:",
    btnProceed: "ಎನ್‌ಮೆ ಮುಂದು ಪೊರ್ಲೆ",
    btnGoBack: "ಪೊರ್ಲೆ ಹಿಂದತ್ತ್ (ಸಲಹೆ)",
    warningInfo:
      "ನಿಂಗ ಬಳ್ಸರೆ ಪರಯರ್ ಪುಟ ದುಷ್ಟಪಟಾಯಿನಿ. ಇದ್ ನಿಂಗ ಸಾಪ್ಟ್‌‌ವೇರ್ ಇನ್ಸ್ಟಾಲ್ ಮಲ್ಪೆರ್‌ಗು ಅಥವಾ ವೈಯಕ್ತಿಕ ಮಾಹಿತ್ ದೆರೆಪೆರ್‌ಗು ಗಂಡುಪಾಡ್ ಮಲ್ಪುಲೆ.",
  },
};
